# HOME ASSISTANT SENIOR AUDIT MODE — v8.3

> **Smarthome TruyenND** · cập nhật 2026-06-27
...
| packages | **19** |
| command_line | **1** |
| dead_entities / stale_restored | **0 orphan / 12 stale** (v8.3: Glances transient — giảm từ 24; bao gồm veth114/dm_20/sdd* — BENIGN, KHÔNG xóa) |
| repairs | **0** (v8.1 resolved Telegram Bot repair; 1 dismissed) |
| sensor domain | **199** entities (v8.3: ↑ từ 188 — entity mới, drift bình thường) |
| switch domain | **108** entities (v8.3: ↑ từ 107) |
