...
| LXC 110 | zigbee2mqtt | Z2M `2.12`; coordinator **SMLIGHT SLZB-06U** (CC2652P, ZStack3x0 20221226) · TCP `192.168.31.45:6638` · IEEE `00124b003e49dc03`; CC2538 USB đã tháo (backup tại `/opt/zigbee2mqtt/data/.backup_cc2538/` + NAS `/volume2/Proxmox/backups/zigbee2mqtt/cc2538_backup_20260625_110159/`) |
...
**Trạng thái:** ✅ v8.1 · HA config valid · **Telegram Bot repair ĐÃ XỬ LÝ** (RESOLVED 2026-06-25: config sạch không `target:`, repair là tàn dư runtime; ignore qua `repairs/ignore_issue` WS → `repair_count: 0`) · 0 orphans · 24 stale_restored Glances transient · 17 files/32 IDs ✅ · 16 scripts / 19 packages / 1 command_line · DIR-ONLY automation · recorder DB audit (§8.2) · backup REST native (dedup) · LXC topology rõ · Frigate live+AI only, record off + snapshots on retain 7d, **Tailscale tailnet-only** · OpenClaw stale unit fixed · Mosquitto owner fixed · Broadlink timeout LOW cần theo dõi.
