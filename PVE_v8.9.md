# NAS + Proxmox VM Audit & Optimization Prompt — v8.9
> Synology DVA1622 trên Proxmox 8.x · Cập nhật từ phiên 2026-07-02 (v8.9)
...
| Backup job vmid | vzdump weekly: **`101,102,104,105,106,107,108,111,112,113`** (v8.7: tự đồng bộ CT105 thay CT110 — PVE-side); `backup-all.sh` ctids: **`(102 104 105 106 107 108 111 113)`** (v8.7 FIX: CT110→CT105, backup `.bak-20260630`) | Thiếu CT mới = backup gap |
