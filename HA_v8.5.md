# HOME ASSISTANT SENIOR AUDIT MODE — v8.5

> **Smarthome TruyenND** · cập nhật 2026-06-29 (v8.5)
...
| LXC 105 | zigbee2mqtt-new | Z2M `2.12` (⚠️ v8.5: đã chuyển từ LXC 110 sang LXC 105, LXC 110 còn tồn tại nhưng không chạy) |
...
**Ổ cắm Zigbee 20A (0xa4c138f64fc46e6e) LQI=0 (v8.5 — CẦN XỬ LÝ):** Network map 29/6: LQI device→coordinator = 0, coordinator→device = 9. Z2M log: OTA update fail (`No image currently available`). Thiết bị gần như không liên lạc được. **Cần re-pair hoặc kiểm tra vật lý thiết bị.**
**Cầu thang 4 (0xec1bbdfffed101d2) LQI=13 (v8.5 — THEO DÕI):** Network map 29/6: LQI device→coordinator = 13 (yếu thật, không phải CC2652P artifact). Coordinator→device = 97 (OK). Khả năng tường dày / xa coordinator. Cân nhắc thêm router Zigbee mains-powered trung gian hoặc di chuyển thiết bị.
